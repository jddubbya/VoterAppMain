...
* Type: page
* Arguments: none
* Description: The page used to display the Privacy Policy
*/
      ...
      <section className="pageCont">
        <section className="privacySection">
          ...
          <p>
            ...
            you agree that this Privacy Policy governs your use of our Services
            and any dispute concerning the Services. Please take a few minutes to
            ...
            <ol type="1">
              <li>
                information users voluntarily supply when using the Services, and
              </li>
              <li>
                information collected automatically through users use of the
                Services.
              </li>
            </ol>
            ...
            <ol>
              <li>
                Your use of the Services, including traffic data, location data,
                logs, and other communication data and the resources that you
                access and use within the Services;
              </li>
              <li>
              ...
              <li>
                ...
                which can sometimes be used to locate your general geographic
                area, operating system, and browser type;
              </li>
              <li>
                Your device type, screen size, browser type, language and other
                settings, memory capacity, plug-ins, internet domain, TCP
                configuration parameters, operating system, carrier code, time
                zone and the names, versions and package IDs of software installed
                on your device;
              </li>
              <li>
              ...
              <li>
                ...
                numbers, that can identify the physical location of devices in
                accordance with applicable law;
              </li>
              <li>Standard server log information; and </li>
              <li>
                Information collected through embedded scripts, cookies, web
                beacons, and other tracking technologies (see additional
            ...
            interests. Third-party companies that provide some of the tools and
            features accessible through our Services and other websites also may
            use tracking technologies to collect information about your use of our
            Services. A “cookie” is a small text file (often containing a unique
            identifier) that helps us to make your use of our Services more
            enjoyable and meaningful to you. Cookies are accessed and recorded by
            the websites you visit, and by the companies that deliver the
            advertisements you see on our Services, so they can recognize the same
            browser navigating online. Cookies can also help you avoid having to
            log in every time you come back to use the Services. They also allow
            us to tailor a website to better match your interests and preferences.
            There are a couple different types of cookies. A “session” cookie is
            stored only in your computers working memory and lasts only for your
            browsing session. When you close all of your browsers windows, or when
            you shut down your computer, the session cookie disappears forever. A
            “persistent” cookie is stored on your computers hard drive until a
            specified date, which could be tomorrow, next week, or 10 years from
            now. Persistent cookies stay on your computer until they either, a)
            expire; b) are overwritten with newer cookies; or c) you manually
            remove them. Most browsers can be configured not to accept cookies.
            This may, however, prevent you from having access to some site
            functions or features. Your browser can also notify you when a cookie
            is set. (Check the “Help” menu of your browser to learn how to change
            your cookie preferences.) Please be aware that certain browsers cannot
            block or delete so-called “Flash” cookies, which use a feature of the
            Adobe Flash video player to store information on your computer. For
            information about how to delete Flash cookies, please visit the Adobe
            website here. The Services may use spotlight ads/web beacons/GIF/pixel
            tags, which are site instrumentation tools that help us to determine,
            for instance, whether a page has been viewed or not; and if so, how
            many times. In general, any electronic image viewed as part of a
            webpage, can act as a web beacon, which is a small string of code that
            embeds a small graphic image (usually invisible) on a web page or in
            an email. When your browser downloads a web beacon, the server that
            sends the corresponding image to your browser can recognize and store
            certain types of information such as cookies previously set, the time
            ...
            information. In order to do this, your location information may be
            shared with our agents or vendors. If you access the Services through
            a mobile device and you do not want your device to automatically
            provide us with location-tracking information, you can disable the GPS
            or other location-tracking functions on your device, provided your
            device allows you to do this. See your device manufacturers
            ...
            parties. When you use one of those sharing tools, the third-party
            company that operates the tool may be collecting information about
            ...
            <ol>
              ...
              <li>
                To evaluate and improve the Services, including content, layout,
                procedures, and navigation, and troubleshoot and perform analytics
                on the Services;
              </li>
              ...
              <li>
                To send you alerts or other communications via email and/or text
                message or other media;
              </li>
              <li>
                To allow us to personalize the content hat you see on the Services
                and to understand how users interact with and use our Services;
              </li>
              <li>
              ...
              <li>
                ...
                effectiveness, usability, or popularity of the Services; and
              </li>
              <li>
            ...
            these service providers such information as is useful or necessary to
            provide you with the services we offer through that service provider.
            The service providers that have access to personally identifiable
            ...
            identifying to you. Our service providers may combine information
            about you with information that we or they collect about other users
            of our Services or other web services and share it in a form that does
            not identify you personally. Our service providers may use such
            aggregated information or other anonymous information and disclose it
            to third parties for any purpose.
            <h4>Legal Uses</h4>
            We may disclose your Personal Information to comply with any court
            order, law, or legal process, including in response to any government
            ...
            beacons in our email messages, turn images “off” in your email system
            ...
            settings. This will prevent further collection of your precise device
            location information. Each operating system, iOS for Apple devices,
            and Android for Android devices, provides its own instructions on how
            to turn off precise location sharing. Access the privacy settings for
            your mobile device or contact your platform operator for more
            information.
            <h3>Information Security</h3>
            We have implemented reasonable administrative, technical, and physical
            security measures to protect against unauthorized access, destruction,
            or alteration of your information. No security system is impenetrable,
            however, we cannot guarantee the security of our databases, nor can we
            guarantee that information you supply won’t be intercepted while being
            transmitted to us over the internet or that information we collect
            will never be disclosed in a manner that is inconsistent with this
            Privacy Policy.
            <h3>Correcting or Updating Your Information</h3>
            You may update or access and edit certain personally identifying
            ...
            governs the Services, and United States data protection laws may not
            be as protective as those in your country. If you are outside the
            United States or are not a United States citizen, you should not use
            the Services. User information will be transferred to, stored, and
            processed in the United States where our servers are located and our
            databases are operated, and you consent to the use and storage of your
            ...
            changes to this Privacy Policy will mean you accept those changes.
          </p>
        </section>
        <section>
